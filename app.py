...
model = load_model('Gamified_Fitness_Platform-main\model.h5')
import json
import random

ts = json.loads(open('Gamified_Fitness_Platform-main\data.json').read())
words = pickle.load(open('Gamified_Fitness_Platform-main\\texts.pkl','rb'))
classes = pickle.load(open('Gamified_Fitness_Platform-main\labels.pkl','rb'))
...
def chatbot_response(msg):
    ...
    res = getResponse(ints, indentsize)
    return res
